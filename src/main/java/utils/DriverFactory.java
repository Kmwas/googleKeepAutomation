...
public class DriverFactory {
    ...
    private static void setCapabilities(DesiredCapabilities desiredCapabilities) {
        File appDir = new File(DeviceProperties.appDir);
        desiredCapabilities.setCapability(MobileCapabilityType.APP, new File(appDir, DeviceProperties.appName).getAbsolutePath());
